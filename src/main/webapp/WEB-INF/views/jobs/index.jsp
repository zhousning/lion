...
<base href="<%=basePath%>">
<meta charset="UTF-8">
<title><fmt:message key="jobs.index"></fmt:message></title>
			...
			<div class="col-md-10 main-container">
				...
				<div class="container-fluid">
					<div class="page-header">
						<h1>
							<fmt:message key="jobs.index"></fmt:message>
						</h1>
					</div>
					<div class="row">
						<div class="col-md-1">
							<a href="jobs/new" class="btn btn-primary btn-block"> <fmt:message
							...
							<c:if test="${ !empty jobs }">
								<c:forEach items="${ jobs }" var="job"
									...
									<tr>
										...
										<td>${ job.name }</td>
										<td><a href="jobs/${job.id }" class="btn btn-info"><fmt:message
													key="btn.info"></fmt:message></a> <a
											href="jobs/${job.id }/edit" class="btn btn-success"><fmt:message
													key="btn.edit"></fmt:message></a> <a href="jobs/${job.id}/destroy"
