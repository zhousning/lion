...
<base href="<%=basePath%>">
<meta charset="UTF-8">
<title><fmt:message key="permissions.index"></fmt:message></title>
			...
			<div class="col-md-10 main-container">
				...
				<div class="container-fluid">
					<div class="page-header">
						<h1>
							<fmt:message key="permissions.index"></fmt:message>
						</h1>
					</div>
					<div class="row">
						<div class="col-md-1">
							<a href="permissions/new" class="btn btn-primary btn-block"> <fmt:message
						...
						<thead>
							<tr class="text-center">
								...
								<th data-field="name" data-filter-control="input"><fmt:message
										key="permission.name"></fmt:message></th>
								<th data-field="url" data-filter-control="input"><fmt:message
										key="permission.url"></fmt:message></th>
								<th></th>
							</tr>
						</thead>
						<tbody>
