...
<base href="<%=basePath%>">
<meta charset="UTF-8">
<title><fmt:message key="roles.index"></fmt:message></title>
			...
			<div class="col-md-10 main-container">
				...
				<div class="container-fluid">
					<div class="page-header">
						<h1>
							<fmt:message key="roles.index"></fmt:message>
						</h1>
					</div>
					<div class="row">
						<div class="col-md-1">
							<a href="roles/new" class="btn btn-primary btn-block"> <fmt:message
