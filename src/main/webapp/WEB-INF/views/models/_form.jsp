<form:form action="models" method="POST" modelAttribute="model"
	...
	<div class="form-group">
		<div class="col-sm-1">
			<button type="button" class="btn btn-primary" id="btn-add-attribute">Attribute Add</button>
		</div>
	</div>
	<div id="attribute-ctn">
		<div class="form-group attr-content">
			...
			<div class="col-sm-1">
				<input list="attLabelDataList" type="text" class="form-control" id="name-label" placeholder="label"
					name="labels" />
			...
			<div class="col-sm-2">
				<select id="js-name-constraint" class="form-control" name="constraints">
		...
		<div class="form-group attr-content">
			...
			<div class="col-sm-1">
				<input list="attLabelDataList" type="text" class="form-control js-attrlabel" placeholder="label"
					name="labels" />
			</div>
			<div class="col-sm-1">
				<input list="attrNameList" type="text" class="form-control"
	...
	<div class="form-group">
		<div class="col-sm-1">
			<button type="button" class="btn btn-primary" id="btn-add-associate">Associate Add</button>
		</div>
	</div>
